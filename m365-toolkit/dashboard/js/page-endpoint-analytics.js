...
const PageEndpointAnalytics = (function() {
    ...
    function extractDevices(rawData) {
        ...
        return devices.map(function(d) {
            ...
            return {
                ...
                batteryHealthScore: d.batteryHealthScore || null,
                cloudManagementScore: d.cloudManagementScore || null,
    ...
    function renderDeviceList(container, rawData) {
        ...
        colSelector = ColumnSelector.create({
            ...
            allColumns: [
                ...
                { key: 'batteryHealthScore', label: 'Battery Health' },
                { key: 'cloudManagementScore', label: 'Cloud Mgmt' },
    ...
    function renderDevicesTable(data) {
        ...
        var allDefs = [
            ...
            { key: 'batteryHealthScore', label: 'Battery Health', formatter: formatScoreText },
            { key: 'cloudManagementScore', label: 'Cloud Mgmt', formatter: formatScoreText },
